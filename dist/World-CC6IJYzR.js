import{A as v}from"./app.js";import{R as m}from"./Resources-DGiz5Izq.js";import{i as d}from"./index-_L0I9zhC.js";import{S as p,U as r,C as g,V as a,P as l,M as x,a as u,b as w}from"./GL-D_VvO4-c.js";import y from"./VideoLoader-CTtbx0ai.js";import"./isSafari-DYs6RIMp.js";var R=`uniform float uOffset;
...
void main()
{
    ...
    gl_FragColor = color;
}`;const c=v.getInstance();let h=null;class C{constructor(t,e,o,s){h=t,this.scene=e,this.main=o,this.item=s,this.sizes=c.sizes,this.time=c.time,this.rect=this.item.getBoundingClientRect(),this.init()}init(){this.setMaterial(),this.setMesh()}setMaterial(){this.material=new p({vertexShader:R,fragmentShader:A,transparent:!0,depthTest:!1,uniforms:{uTexture:new r(null),uRes:new r(new a(this.sizes.width,this.sizes.height)),uAspect:new r(new a(16,9)),uSize:new r(new a(0,0)),uBorder:new r(0),uReveal:new r(0),uRotate:new r(0),uRotateX:new r(0),uRotateY:new r(0),uRadius:new r(.02),uScroll:new r(0),uZoom:new r(.55),uTime:new r(0),uFluid:new r(null),uOffset:new r(null),uParallax:new r(0),uColor:new r(new g(255/255,118/255,162/255))}})}setMesh(){this.geometry=new l(this.rect.width,this.rect.height,1,1),this.mesh=new x(this.geometry,this.material),this.material.uniforms.uSize.value.set(this.rect.width,this.rect.height);const t=this.item.querySelector("video");t&&this.setupVideoTexture(t),this.scene.add(this.mesh),this.setPosition()}setupVideoTexture(t){if(t._videoLoaderInstance){const e=t._videoLoaderInstance;if(e.isLoaded){const o=new u(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width||t.videoWidth,e.height||t.videoHeight)}else e.on("loaded",()=>{const o=new u(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width,e.height)})}else{const e=new y(t,{lazyLoad:!1});e.on("loaded",()=>{const o=new u(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width,e.height)})}}setPosition(t){this.rect=this.item.getBoundingClientRect(),this.mesh.position.x=this.rect.left+this.rect.width/2-this.sizes.width/2,this.mesh.position.y=-this.rect.top-this.rect.height/2+this.sizes.height/2}resize(){this.rect=this.item.getBoundingClientRect(),w(this.mesh,new l(this.rect.width,this.rect.height,1,1)),this.material.uniforms.uSize.value.set(this.rect.width,this.rect.height),this.material.uniforms.uRes.value.set(this.sizes.width,this.sizes.height)}update(){this.material.uniforms.uFluid.value=h.fluidTexture}destroy(){this.material.dispose(),this.mesh.geometry.dispose(),this.scene.remove(this.mesh)}}const n=v.getInstance();let i=null;class M{constructor(t,e,o){i=t,this.scene=e,this.main=o,this.sizes=n.sizes,this.renderer=i.renderer.instance,this.camera=i.camera.instance,this.scene=e,this.load()}load(){this.hero=this.main.querySelector(".h-services"),this.item=this.hero.querySelector(".h-services_bg"),this.footerLogo=this.main.querySelector(".footer_logo"),this.sources=[],this.footerLogo&&(this.getTextureAttributes(this.footerLogo).forEach(({value:e},o)=>{this.sources.push({type:"textureLoader",url:e,name:`footer-${o}`})}),gsap.set(this.footerLogo,{opacity:0})),this.resources=new m(this.sources),this.resources.on("ready",()=>this.init())}init(){if(i.loaded=!0,this.hero=new C(i,this.scene,this.main,this.item),this.footerLogo){this.footerMeshs=[];const t=this.getTextureAttributes(this.footerLogo);this.footerTextures=t.map((e,o)=>{const s=`footer-${o}`;return this.resources.items[s]}),this.footerTextures.forEach((e,o)=>{this.footerMeshs[o]=new d(i,this.scene,this.footerLogo,e,o)})}n.trigger("loadedWorld"),n.onceLoaded||(n.globalLoader.tl.play(),n.page.triggerLoad())}setScroll(t){var e,o;(e=this.hero)==null||e.setPosition(t),(o=this.footerMeshs)==null||o.forEach(s=>s.setPosition())}update(){var t,e;(t=this.hero)==null||t.update(),(e=this.footerMeshs)==null||e.forEach(o=>o.update())}createTexture(t){return this.renderer.setRenderTarget(t),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),t.texture}resize(){var t,e;(t=this.hero)==null||t.resize(),(e=this.footerMeshs)==null||e.forEach(o=>o.resize())}onMouseMove(t,e){}destroy(){var t,e;(t=this.hero)==null||t.destroy(),(e=this.footerMeshs)==null||e.forEach(o=>o.destroy())}getTextureAttributes(t){return t.getAttributeNames().filter(e=>e.startsWith("data-texture-")).map(e=>({name:e,value:t.getAttribute(e),number:parseInt(e.split("-")[2])})).sort((e,o)=>e.number-o.number)}}export{M as default};
