import{R as A}from"./Resources-DqIBCYYJ.js";import{i as C}from"./index-BnYIZcmD.js";import{g as z}from"./index-Cn1KrK_M.js";import{S as g,U as n,C as x,V as u,P as h,M as R,a as l,b as y}from"./GL-Dvc-z8VT.js";import w from"./VideoLoader-DDzJuXJh.js";import{g as U}from"./all-Cn1KrK_M.js";import{S as m}from"./ScrollTrigger-BWsqEc1I.js";import"./app.js";import"./CSSPlugin-YLlZY2Jb.js";var S=`uniform float uOffset;
...
void main()
{
    ...
    gl_FragColor = color;
}`;let P=class{constructor(t,e,o,i,c){this.app=t,this.gl=e,this.scene=o,this.main=i,this.item=c,this.sizes=this.app.sizes,this.time=this.app.time,this.rect=this.item.getBoundingClientRect(),this.init()}init(){this.setMaterial(),this.setMesh()}setMaterial(){this.material=new g({vertexShader:S,fragmentShader:T,transparent:!0,depthTest:!1,uniforms:{uTexture:new n(null),uRes:new n(new u(this.sizes.width,this.sizes.height)),uAspect:new n(new u(16,9)),uSize:new n(new u(0,0)),uBorder:new n(0),uReveal:new n(0),uRotate:new n(0),uRotateX:new n(0),uRotateY:new n(0),uRadius:new n(.02),uScroll:new n(0),uZoom:new n(.55),uTime:new n(0),uFluid:new n(null),uOffset:new n(null),uParallax:new n(0),uColor:new n(new x(255/255,118/255,162/255))}})}setMesh(){this.geometry=new h(this.rect.width,this.rect.height,1,1),this.mesh=new R(this.geometry,this.material),this.material.uniforms.uSize.value.set(this.rect.width,this.rect.height);const t=this.item.querySelector("video");if(t)if(t.style.opacity=0,t._videoLoaderInstance){const e=t._videoLoaderInstance;if(e.isLoaded){const o=new l(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width||t.videoWidth,e.height||t.videoHeight)}else e.on("loaded",()=>{const o=new l(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width,e.height)})}else{const e=new w(t,{lazyLoad:!1});e.on("loaded",()=>{const o=new l(t);this.material.uniforms.uTexture.value=o,this.material.uniforms.uAspect.value.set(e.width,e.height)})}this.scene.add(this.mesh),this.setPosition()}setPosition(t){this.rect=this.item.getBoundingClientRect(),this.mesh.position.x=this.rect.left+this.rect.width/2-this.sizes.width/2,this.mesh.position.y=-this.rect.top-this.rect.height/2+this.sizes.height/2}resize(){this.rect=this.item.getBoundingClientRect(),y(this.mesh,new h(this.rect.width,this.rect.height,1,1)),this.material.uniforms.uSize.value.set(this.rect.width,this.rect.height),this.material.uniforms.uRes.value.set(this.sizes.width,this.sizes.height)}update(){this.material.uniforms.uFluid.value=this.gl.fluidTexture}destroy(){this.material.dispose(),this.mesh.geometry.dispose(),this.scene.remove(this.mesh)}};var M=`varying vec2 vUv;
varying vec2 screenUv;
