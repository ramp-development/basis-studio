...
void main()
{
    ...
    gl_FragColor = color;
}`;p.registerPlugin(f);class X{constructor(e,t,o,s){this.app=e,this.gl=t,this.scene=o,this.main=s,this.sizes=this.app.sizes,this.time=this.app.time,this.items=this.main.querySelectorAll(".double-video, .cases_video"),this.init()}init(){this.setMaterial(),this.setMesh()}debug(){if(!this.app.debug.active)return;const e=this.app.debug.gui;this.folder=e.addFolder("Home/Video"),this.folder.add(this.material.uniforms.uReveal,"value",0,1,.01).name("uReveal").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uReveal.value=t)}),this.folder.add(this.material.uniforms.uRotate,"value",0,2,.01).name("uRotate").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uRotate.value=t)}),this.folder.add(this.material.uniforms.uRadius,"value",0,1,.01).name("uRadius").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uRadius.value=t)}),this.folder.add(this.material.uniforms.uRotateX,"value",-1,1,.01).name("uRotateX").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uRotateX.value=t)}),this.folder.add(this.material.uniforms.uRotateY,"value",-1,1,.01).name("uRotateY").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uRotateY.value=t)}),this.folder.add(this.material.uniforms.uZoom,"value",-1,1,.01).name("uZoom").onChange(t=>{this.meshs.forEach(({material:o})=>o.uniforms.uZoom.value=t)})}setMaterial(){this.material=new x({vertexShader:B,fragmentShader:D,transparent:!0,depthTest:!1,uniforms:{uTexture:new n(null),uRes:new n(new l(this.sizes.width,this.sizes.height)),uAspect:new n(new l(16,9)),uSize:new n(new l(0,0)),uBorder:new n(0),uReveal:new n(0),uRotate:new n(0),uRotateX:new n(0),uRotateY:new n(0),uRadius:new n(.02),uZoom:new n(.55),uTime:new n(0),uFluid:new n(null),uParallax:new n(0),uColor:new n(new R(255/255,118/255,162/255))}})}setMesh(){this.meshs=[...this.items].map((e,t)=>{const o=window.getComputedStyle(e).getPropertyValue("border-radius").split("px"),s=e.getBoundingClientRect(),c=new m(s.width,s.height,1,1),i=this.material.clone();i.uniforms.uSize.value.set(s.width,s.height),i.uniforms.uBorder.value=parseFloat(o[0]);const C=e.classList.contains("cases_video"),b=e.classList.contains("double-video");C?i.uniforms.uZoom.value=.55:b?i.uniforms.uZoom.value=1:i.uniforms.uZoom.value=.9;const h=new y(c,i);e.classList.contains("cases_video")&&(h.visible=!1);const a=e.querySelector("video");if(a)if(a._videoLoaderInstance){const r=a._videoLoaderInstance;if(r.isLoaded){const u=new v(a);i.uniforms.uTexture.value=u,i.uniforms.uAspect.value.set(r.width||a.videoWidth,r.height||a.videoHeight)}else r.on("loaded",()=>{const u=new v(a);i.uniforms.uTexture.value=u,i.uniforms.uAspect.value.set(r.width,r.height)})}else{const r=new U(a,{lazyLoad:!1});r.on("loaded",()=>{const u=new v(a);i.uniforms.uTexture.value=u,i.uniforms.uAspect.value.set(r.width,r.height)})}this.scene.add(h),this.app.observer.instance.observe(e);const d=p.timeline({paused:!0,defaults:{duration:1,ease:"power3.out"}});return e.classList.contains("talk_full")?(h.scale.set(.3,.3,.3),d.to(i.uniforms.uReveal,{value:1,duration:.1}).to(h.scale,{x:1,y:1,z:1,duration:1.2,ease:"back.out(1.2)"},"<0.1").fromTo(i.uniforms.uRotate,{value:-.3},{value:0},"<0.1").fromTo(i.uniforms.uRotateY,{value:.8},{value:0},"<0.1").fromTo(i.uniforms.uRotateX,{value:-.8},{value:0},"<0.1").fromTo(i.uniforms.uRadius,{value:0},{value:.02,duration:.2},"<0.8")):d.to(i.uniforms.uReveal,{value:1}).fromTo(i.uniforms.uRotate,{value:-.3},{value:0},"<").fromTo(i.uniforms.uRotateY,{value:.8},{value:0},"<").fromTo(i.uniforms.uRotateX,{value:-.8},{value:0},"<").fromTo(i.uniforms.uRadius,{value:0},{value:.02,duration:.2},"<"),f.create({trigger:e,start:"top 90%",onEnter:()=>d.play()}),f.create({trigger:e,start:"top bottom",onLeaveBack:()=>d.pause(0)}),e.classList.contains("preview_img")&&f.create({trigger:e,start:"top bottom",end:"bottom top",onUpdate:r=>{const u=r.progress,z=p.utils.mapRange(0,1,-.2,.2,u);i.uniforms.uParallax.value=z}}),{mesh:h,item:e,material:i}}),this.setPosition()}setPosition(){this.meshs.forEach(({mesh:e,item:t})=>{if(t.dataset.visible=="false"||t.classList.contains("cases_video")){e.visible=!1;return}//! HERE FOR POSITION
e.visible=!0;const o=t.getBoundingClientRect();e.position.x=o.left+o.width/2-this.sizes.width/2,e.position.y=-o.top-o.height/2+this.sizes.height/2})}resize(){this.meshs.forEach(({mesh:e,item:t})=>{const o=t.getBoundingClientRect();w(e,new m(o.width,o.height,1,1)),e.material.uniforms.uSize.value.set(o.width,o.height);const s=window.getComputedStyle(t).getPropertyValue("border-radius").split("px");e.material.uniforms.uBorder.value=parseFloat(s[0])})}update(){this.meshs.forEach(({material:e})=>{e.uniforms.uFluid.value=this.gl.fluidTexture})}destroy(){this.meshs.forEach(({mesh:e,material:t})=>{t.dispose(),e.geometry.dispose(),this.scene.remove(e)})}}class G{constructor(e,t,o,s){this.gl=e,this.app=t,this.scene=o,this.main=s,this.sizes=this.app.sizes,this.renderer=this.gl.renderer.instance,this.camera=this.gl.camera.instance,this.scene=o,this.load()}load(){this.isCasesPage=document.querySelector("main").dataset.transitionPage==="case-inner",this.heroInner=this.main.querySelector(".inner-hero"),this.heroItem=this.heroInner.querySelector(".inner-hero_bg"),this.footerLogo=this.main.querySelector(".footer_logo"),this.sources=[],this.footerLogo&&(this.getTextureAttributes(this.footerLogo).forEach(({value:t},o)=>{this.sources.push({type:"textureLoader",url:t,name:`footer-${o}`})}),A.set(this.footerLogo,{opacity:0})),this.resources=new S(this.sources),this.resources.on("ready",()=>this.init())}init(){if(this.gl.loaded=!0,this.video=new X(this.app,this.gl,this.scene,this.main),this.footerLogo){this.footerMeshs=[];const e=this.getTextureAttributes(this.footerLogo);this.footerTextures=e.map((t,o)=>{const s=`footer-${o}`;return this.resources.items[s]}),this.footerTextures.forEach((t,o)=>{this.footerMeshs[o]=new T(this.app,this.gl,this.scene,this.footerLogo,t,o)})}this.isCasesPage&&(this.hero=new M(this.app,this.gl,this.scene,this.main,this.heroItem)),this.app.trigger("loadedWorld"),this.app.onceLoaded||(this.app.globalLoader.tl.play(),this.app.page.triggerLoad())}setScroll(e){var t,o,s;(t=this.video)==null||t.setPosition(),(o=this.hero)==null||o.setPosition(e),(s=this.footerMeshs)==null||s.forEach(c=>c.setPosition(e))}update(){var e,t,o;(e=this.video)==null||e.update(),(t=this.hero)==null||t.update(),(o=this.footerMeshs)==null||o.forEach(s=>s.update())}createTexture(e){return this.renderer.setRenderTarget(e),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),e.texture}resize(){var e,t,o;(e=this.video)==null||e.resize(),(t=this.hero)==null||t.resize(),(o=this.footerMeshs)==null||o.forEach(s=>s.resize())}onMouseMove(e,t){}destroy(){var e,t,o;(e=this.video)==null||e.destroy(),(t=this.hero)==null||t.destroy(),(o=this.footerMeshs)==null||o.forEach(s=>s.destroy())}getTextureAttributes(e){return e.getAttributeNames().filter(t=>t.startsWith("data-texture-")).map(t=>({name:t,value:e.getAttribute(t),number:parseInt(t.split("-")[2])})).sort((t,o)=>t.number-o.number)}}export{G as default};
