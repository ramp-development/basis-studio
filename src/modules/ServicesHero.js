...
export default class ServicesHero
{
    ...
    init()
    {
        ...
        const top = this.title.getBoundingClientRect().top + this.title.getBoundingClientRect().height / 2 - middleY
        ...
        }, context =>
        {
            ...
            this.tl.fromTo(this.title, {y: 0}, {y: -top, ease: 'power3', duration: 1})
            .fromTo(this.text, {scale: 1}, {scale: isDesktop ? 1.4 : 1.1, ease: 'power3', duration: 1}, '<')
            .fromTo(this.btn, {yPercent: 100, opacity: 0}, {yPercent: 0, opacity: 1, ease: 'power3', duration: 0.5}, 0.5)
        })
        ...
        this.scroll = ScrollTrigger.create(
        {
            ...
            onUpdate: self =>
            {
                ...
                {
                    if(this.app.gl.world.hero) this.app.gl.world.hero.material.uniforms.uScroll.value = self.progress
                }
