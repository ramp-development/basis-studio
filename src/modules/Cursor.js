...
export default class Cursor
{
    constructor(instance, app, main)
    {
        ...
        window.addEventListener('mousemove', e =>
        {
            ...
            const remapedX = gsap.utils.clamp(0, 1, gsap.utils.mapRange(0.9, 1.0, 0, 1, Math.abs(cursor.x)))
            const remapedY = gsap.utils.clamp(0, 1, gsap.utils.mapRange(0.9, 1.0, 0, 1, Math.abs(cursor.y)))
